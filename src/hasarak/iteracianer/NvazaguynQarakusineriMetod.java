...
public class NvazaguynQarakusineriMetod extends CoefficientMatrices{
    public NvazaguynQarakusineriMetod(Matrix A, Vector b){
        setA(A);
        setB(b);
        setName("Նցազագույն քառակուսիների մեթոդ");
    }
